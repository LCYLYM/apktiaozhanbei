  ...
  const renderView = () => {
    switch (view) {
      ...
      case ViewState.PROFILE:
        return <Profile onBack={() => setView(ViewState.DASHBOARD)} currentProfile={userProfile} onSave={handleProfileSave} />;
      case ViewState.DASHBOARD:
      default:
        return <BentoGrid onNavigate={setView} isOnline={isOnline} />;
    }
  };
